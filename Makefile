...
build-images: build-image/hub build-image/proxy build-image/singleuser-sample build-image/builder
push-images: push-image/hub push-image/proxy push-image/singleuser-sample push-image/builder
